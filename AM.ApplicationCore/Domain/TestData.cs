   ...
   public static class TestData
    {
        ...
        public static Staff hostess2 = new Staff { PassportNumber = "3", /* = "hostess2", LastName = "hostess2",*/ EmailAddress = "hostess2.hostess2@gmail.com", BirthDate = new DateTime(1996, 01, 01), EmployementDate =   new DateTime(2020, 01, 01), Salary = 999 };
        // Travellers
        public static Traveller traveller1 = new Traveller { PassportNumber = "4", /*FirstName = "traveller1", LastName = "traveller1*/ EmailAddress = "traveller1.traveller1@gmail.com", BirthDate = new DateTime(1980, 01, 01), HealthInformation = "no troubles", Nationality = "American" };
        public static Traveller traveller2 = new Traveller { PassportNumber = "5", /*FirstName = "traveller2", LastName = "traveller2",*/ EmailAddress = "traveller2.traveller2@gmail.com", BirthDate = new DateTime(1981, 01, 01), HealthInformation = "Some troubles", Nationality = "French" };
        public static Traveller traveller3 = new Traveller { PassportNumber = "6", /*FirstName = "traveller3", LastName = "traveller3",*/ EmailAddress = "traveller3.traveller3@gmail.com", BirthDate = new DateTime(1982, 01, 01), HealthInformation = "no troubles", Nationality = "Tunisian" };
