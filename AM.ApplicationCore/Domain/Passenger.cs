...
namespace AM.ApplicationCore.Domain
{
    public class Passenger
    {
        ...
        {
            return this.fullName.FirstName.Equals(FirstName) && this.fullName.LastName.Equals(LastName)&& this.EmailAddress.Equals(EmailAdress);
        }
        public override string? ToString()
        {
            return "\nBirthday : "+ BirthDate.ToString()+ " PassportNumber : " + PassportNumber.ToString() + " EmailAdress : " + EmailAddress.ToString()+ " LastName : " +fullName.LastName.ToString()+ " TelNumber : " + TelNumber.ToString();
        }
